...
function testWebSocketVehicleUpdate() {
 return new Promise((resolve, reject) => {
  ...
  socket.on("connect", () => {
   ...
   console.log("📡 Requested to join dashboard_updates and vehicle_updates rooms");
  });
...
async function runTest() {
 ...
 try {
  ...
  console.log("\n✅ Test results:");
  console.log(`- Vehicle Updated Event: ${eventReceived ? "✅ Received" : "❌ Not received"}`);
  console.log(`- Dashboard Stats Event: ${dashboardEventReceived ? "✅ Received" : "❌ Not received"}`);
  ...
  console.log("🔍 Check server logs and ensure WebSocket service is properly broadcasting events");
 }
}
