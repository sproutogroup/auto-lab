...
const vapidPublicKey =
  ...
  "BEl62iUYgUivxIkv69yViEuiBIa40HcCWLaS4N-YwwJDtfKGjXRzlGTfVjj0M2fYbC7dF9gH";
const vapidPrivateKey =
  process.env.VAPID_PRIVATE_KEY ||
  "kVSuFSCysVD7WVmZkbkm4bOzjF7oHzKkQf4qCMFJKf0";
...
async function testPushNotification() {
  try {
    ...
    if (error.statusCode === 404 || error.statusCode === 410) {
      console.log(
        "✅ Encryption successful - endpoint not found is expected for test",
      );
