...
try {
  ...
  if (
    ...
    testPassed(
      "Push notification encryption works (test endpoint invalid as expected)",
    );
  } else {
...
if (existsSync(swPath)) {
  ...
  if (
    ...
    swContent.includes("self.addEventListener")
  ) {
...
console.log(
  "VAPID_PRIVATE_KEY=" +
    (vapidPrivate ? vapidPrivate.substring(0, 10) + "..." : "NOT_SET"),
);
