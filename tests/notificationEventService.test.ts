...
describe("NotificationEventService", () => {
  ...
  beforeEach(() => {
    ...
    mockWebPushService =
      WebPushService.getInstance() as jest.Mocked<WebPushService>;
  });
...
describe("NOTIFICATION_REGISTRY", () => {
  ...
  it("should have correct recipient criteria for vehicle.updated", () => {
    ...
    expect(event.recipient_criteria.preference_key).toBe(
  ...
  it("should have correct recipient criteria for vehicle.sold", () => {
    ...
    expect(event.recipient_criteria.roles).toEqual([
      "admin",
      "manager",
      "salesperson",
    ]);
