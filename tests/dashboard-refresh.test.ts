...
describe("Dashboard Real-time Updates", () => {
  ...
  it("should automatically refresh dashboard when vehicle is added", async () => {
    ...
    expect(updatedStats.stockSummary.totalValue).toBeGreaterThan(
      initialStats.stockSummary.totalValue,
    );
  });
  ...
  it("should automatically refresh dashboard when vehicle status is updated", async () => {
    ...
    expect(updatedStats.monthlySales.thisMonth).toBeGreaterThan(
      initialStats.monthlySales.thisMonth,
    );
    expect(updatedStats.monthlySales.thisMonthValue).toBeGreaterThan(
      initialStats.monthlySales.thisMonthValue,
    );
  });
