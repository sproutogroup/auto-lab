...
try {
 ...
 if (indexContent.includes("https://autolabdms.com") && indexContent.includes("https://www.autolabdms.com")) {
...
try {
 ...
 if (manifest.start_url === "/" && manifest.scope === "/" && manifest.icons && manifest.icons.length > 0) {
...
console.log("• CORS Origins: https://autolabdms.com, https://www.autolabdms.com");
