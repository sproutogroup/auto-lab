...
const quickActions = [
 ...
 },
 {
  ...
  query: "Provide a financial overview including profit margins and cash flow",
 },
 {
...
export default function AIBusinessIntelligence() {
 ...
 const quickQueryMutation = useMutation({
  mutationFn: (query: string) => apiRequest("POST", "/api/ai/quick-query", { query }),
      ...
      <CardHeader className="pb-3">
       <CardTitle className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
         ...
         <Button size="sm" variant="outline" onClick={handleClearConversation} className="h-8 px-3">
        ...
        <div className="space-y-4">
         {messages.length === 0 && (
          <div className="text-center py-8 text-gray-500">
           ...
           <p className="text-sm">
            Welcome! I'm your AI business intelligence assistant. Ask me anything about your dealership
            operations, sales performance, inventory management, or customer analytics.
           </p>
          </div>
         )}
        ...
        <form onSubmit={handleSubmit}>
         <div className="flex gap-2">
          <Input
           ...
           disabled={chatMutation.isPending}
          />
          <Button type="submit" disabled={chatMutation.isPending || !inputQuery.trim()}>
