  ...
  const handleToggleNotifications = async () => {
    ...
    try {
      if (isSubscribed) {
          ...
          try {
            ...
            if (permission === "granted") {
              ...
              toast({
                ...
                description:
                  "Local notifications are now enabled. You'll receive notifications while using the app.",
              });
              ...
              toast({
                ...
                description:
                  "Please allow notifications in Safari settings to receive updates.",
                variant: "destructive",
              });
            }
          } catch (error) {
        ...
        const success =
          await pushNotificationManager.subscribeToPushNotifications(userId);
        ...
        if (success) {
          ...
          if (!("serviceWorker" in navigator)) {
            ...
            toast({
              ...
              description:
                "Notifications are allowed but service worker failed to register.",
              variant: "destructive",
            });
          } else {
            toast({
