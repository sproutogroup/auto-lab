...
export default function VehicleModal({
  ...
  const calculateTotalGP = (data: VehicleFormData): number => {
    const salePrice =
      data.sales_status?.toUpperCase() === "SOLD"
        ? calculateTotalSalePrice(data)
        : 0;
  ...
  const mutation = useMutation({
    mutationFn: async (data: VehicleData) => {
      const url =
        mode === "add" ? "/api/vehicles" : `/api/vehicles/${vehicle?.id}`;
      ...
      console.log(
        `[Frontend] Making ${method} request to ${url} for vehicle ${data.id || "new"}`,
      );
      ...
      console.log(
        `[Frontend] Vehicle ${method} response status: ${response.status}`,
      );
    ...
    onSuccess: () => {
      console.log(
        "[VehicleModal] Vehicle save successful, invalidating cache...",
      );
      ...
      console.log(
        "[VehicleModal] Force refetching dashboard stats for immediate update...",
      );
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      console.log(
        "[VehicleModal] Vehicle update successful, invalidating cache...",
      );
      queryClient.invalidateQueries({ queryKey: ["/api/vehicles"] });
      queryClient.invalidateQueries({ queryKey: ["/api/dashboard/stats"] });
      queryClient.invalidateQueries({ queryKey: ["/api/customers/crm-stats"] });
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <DialogDescription>
              {mode === "add"
                ? "Form to add a new vehicle to inventory"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("sales_status", value)
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("collection_status", value)
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("derivative", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("date_of_registration", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="purchase_invoice_date">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("purchase_invoice_date", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("purchase_cash", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("purchase_fees", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                <Label htmlFor="purchase_finance_settlement">
                  Purchase Finance Settlement (£)
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor="purchase_bank_transfer">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("vat", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("sale_date", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("bank_payment", e.target.value)
                  }
                  className="mt-1"
              ...
              <div>
                <Label htmlFor="finance_settlement">
                  Finance Settlement (£)
                </Label>
                <Input
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("px_value", e.target.value)
                  }
                  className="mt-1"
                  disabled={formData.sales_status?.toUpperCase() !== "SOLD"}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("vat_payment", e.target.value)
                  }
                  className="mt-1"
                  disabled={formData.sales_status?.toUpperCase() !== "SOLD"}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("cash_payment", e.target.value)
                  }
                  className="mt-1"
                  disabled={formData.sales_status?.toUpperCase() !== "SOLD"}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("cash_o_b", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("px_o_r_value", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("road_tax", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("alloy_insurance", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("paint_insurance", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("gap_insurance", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("parts_cost", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              <div>
                <Label htmlFor="paint_labour_costs">
                  Paint & Labour Costs (£)
                </Label>
                <Input
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFinancialInputChange("warranty_costs", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                <Label htmlFor="dfc_outstanding_amount">
                  DFC Outstanding Amount (£)
                </Label>
                <Input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("customer_surname", e.target.value)
                  }
                  className="mt-1"
                />
              </div>
