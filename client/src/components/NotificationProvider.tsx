    ...
    try {
      ...
      if (isIOS) {
        toast({
          ...
          description:
            "iOS Safari notifications are now working with local notifications support.",
          variant: "default",
        });
...
export const NotificationTest: React.FC = () => {
  const { requestPermission, isRegistered, platform, notificationPermission } =
    useNotifications();
    ...
    <div className="p-4 border rounded-lg bg-card">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span
            className={`text-sm font-medium ${isRegistered ? "text-green-600" : "text-red-600"}`}
          >
