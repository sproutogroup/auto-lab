...
export function Interactions_Manager({
  leadId,
  mode = "view",
}: interactions_manager_props) {
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">
                  Start by adding your first interaction with this lead
                </p>
              </div>
            </CardContent>
          </Card>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <Badge
                            variant={
                              interaction.interaction_direction === "inbound"
                                ? "default"
                                : "secondary"
                            }
                          ...
                          {interaction.interaction_outcome && (
                            ...
                            >
                              {interaction.interaction_outcome.replace(
                                "_",
                                " ",
                              )}
                            </Badge>
