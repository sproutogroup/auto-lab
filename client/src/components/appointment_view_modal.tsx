    ...
    <DialogHeader className="border-b border-gray-200 pb-4">
     <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
       ...
       <div>
        <DialogTitle className="text-xl font-semibold text-gray-900">Appointment Overview</DialogTitle>
      ...
      <div className="p-4">
       <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
         ...
         <div className="text-sm font-semibold text-gray-900">{formatDate(appointment.appointment_date)}</div>
        </div>
       ...
       <div className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         ...
         <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
          ...
          <div className="text-sm font-semibold text-gray-900">{associatedVehicle.stock_number}</div>
         </div>
