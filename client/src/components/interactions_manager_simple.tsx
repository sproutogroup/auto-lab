...
export function SimpleInteractionsManager({
  ...
  const { data: interactions = [], isLoading: is_loading_interactions } =
        ...
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-sm">
                Interaction tracking will be available after saving the lead
              </p>
            </div>
          </div>
        </CardContent>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
        ...
        {mode !== "view" && (
          <Dialog
            open={is_add_dialog_open}
            onOpenChange={set_is_add_dialog_open}
          >
            ...
            <DialogContent className="max-w-2xl w-[95vw] sm:w-full max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Record a new interaction with the customer including
              ...
              <Form {...form}>
                ...
                >
                        ...
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="finance_discussion">
                                Finance Discussion
                              </SelectItem>
                              <SelectItem value="objection_handling">
                                Objection Handling
                              </SelectItem>
                              <SelectItem value="closing_attempt">
                                Closing Attempt
                              </SelectItem>
                            </SelectContent>
                          </Select>
                        ...
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="sale_progressed">
                                Sale Progressed
                              </SelectItem>
                              <SelectItem value="lost_lead">
                                Lost Lead
                              </SelectItem>
                            </SelectContent>
                          </Select>
                  ...
                  <div className="flex justify-end space-x-2 pt-4">
                    ...
                    >
                      {create_interaction_mutation.isPending
                        ? "Adding..."
                        : "Add Interaction"}
                    </Button>
                  </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                          {(interaction.interaction_type || "unknown").replace(
                            "_",
                            " ",
                          )}{" "}
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 sm:p-4">
                      ...
                      {interaction.follow_up_date && (
                        <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-400 mb-1">
                          ...
                          {format_date(interaction.follow_up_date)}
                        </p>
                      )}
