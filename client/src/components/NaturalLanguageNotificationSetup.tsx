  ...
  <div className="space-y-6">
     ...
     <CardContent className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
       ...
       <div>
        ...
        <div className="mt-1">
         <Badge className={getPriorityColor(parsedRule.priority)}>{parsedRule.priority}</Badge>
        </div>
       </div>
       ...
       <div>
        ...
        <div className="mt-1">
         <Badge variant="outline">{Math.round(parsedRule.confidence * 100)}%</Badge>
        </div>
       </div>
      </div>
   ...
   <Card>
    <CardHeader>
     ...
     <CardDescription>Currently active notification rules that will trigger automatically</CardDescription>
    </CardHeader>
    <CardContent>
        ...
        {existingRules.map(rule => (
         ...
         >
          ...
          <div className="flex items-center gap-2">
           <Badge className={getPriorityColor(rule.priority_level)}>{rule.priority_level}</Badge>
