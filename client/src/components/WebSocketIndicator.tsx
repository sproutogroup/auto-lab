 ...
 return (
  <div className="flex items-center gap-2">
   ...
   <div className="flex items-center gap-2">
    ...
    <span className="text-sm text-muted-foreground hidden sm:block">{getStatusText()}</span>
   </div>
    ...
    <PopoverContent className="w-80" align="end">
     <Card className="border-0 shadow-none">
      <CardHeader className="pb-3">
       ...
       <CardDescription className="text-xs">Users currently active in the system</CardDescription>
      </CardHeader>
             ...
             <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
               ...
               <div className="flex items-center gap-1 mt-1">
                <Badge className={cn("text-xs py-0 px-1", getRoleBadgeColor(user.role))}>{user.role}</Badge>
               </div>
              </div>
             </div>
     ...
     <PopoverContent className="w-64" align="end">
      <div className="space-y-2">
       ...
       {connectionStatus === ConnectionStatus.RECONNECTING && (
        <p className="text-xs text-muted-foreground">Attempting to reconnect... ({reconnectAttempts}/5)</p>
       )}
       {connectionStatus === ConnectionStatus.ERROR && (
        <p className="text-xs text-red-500">Unable to connect to real-time updates</p>
       )}
      </div>
     </PopoverContent>
    </Popover>
