...
export const NotificationTester: React.FC = () => {
 ...
 const testDeviceRegistration = async () => {
  ...
  try {
   ...
   setTestResult(`✓ Device registration successful! Device ID: ${result.id}`);
   toast({
 ...
 const testNotificationSend = async () => {
  ...
  try {
   ...
   if (notificationPermission === "granted") {
    ...
    setTestResult(`✓ Browser notification sent successfully! Notification should appear on your device.`);
  ...
  <div className="space-y-6">
   <Card>
    <CardHeader>
     ...
     <CardDescription>Test and debug the notification system for your iOS device</CardDescription>
    </CardHeader>
    <CardContent>
     <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
       ...
       <Button onClick={testDeviceRegistration} disabled={registering} variant="outline" className="flex-1">
        {registering ? (
       ...
       <Button onClick={testNotificationSend} disabled={testing} className="flex-1">
      ...
      {platform === "ios" && (
       <Alert>
        <AlertCircle className="h-4 w-4" />
        <AlertDescription>
         <strong>iOS Safari Notice:</strong> iOS Safari has limited push notification support. The system uses
         local notifications and fallback methods to provide the best possible experience.
         <br />
