       ...
       <div className="space-y-4">
        ...
        <div>
         ...
         <Select
          ...
          onValueChange={value => setFormData({ ...formData, delivery_collection: value })}
         >
          <SelectTrigger>
    ...
    <Dialog open={!!viewingInvoice} onOpenChange={() => setViewingInvoice(null)}>
     <DialogContent className="max-w-2xl">
      <DialogHeader>
       ...
       <DialogDescription>View complete sales invoice information and document details</DialogDescription>
      </DialogHeader>
        ...
        <div>
         ...
         <p className="text-gray-900">
          {viewingInvoice.delivery_collection
           ? viewingInvoice.delivery_collection.charAt(0).toUpperCase() +
