...
export default function Dashboard() {
  ...
  const { data: customerStats, isLoading: isLoadingCustomerStats } =
    useQuery<CustomerCrmStats>({
  ...
  useEffect(() => {
    ...
    const unsubscribeVehicleEvents = subscribeToEvent(
    ...
    const unsubscribeVehicleCreated = subscribeToEvent(
    ...
    const unsubscribeVehicleDeleted = subscribeToEvent(
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-4">
              <div className="text-center">
                ...
                <div className="text-lg md:text-2xl font-bold text-gray-900 break-all">
                  £
                  {Number(stats.stockSummary.totalValue).toLocaleString(
                    "en-GB",
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-lg md:text-2xl font-bold text-green-600 break-all">
                    £
                    {Number(stats.weeklySales.thisWeekValue).toLocaleString(
                      "en-GB",
                      { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                    )}
                  </div>
              ...
              <div className="pt-2 md:pt-3 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-gray-600 break-all">
                    £
                    {Number(stats.weeklySales.lastWeekValue).toLocaleString(
                      "en-GB",
                      { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                    )}
                  </span>
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-lg md:text-2xl font-bold text-blue-600 break-all">
                    £
                    {Number(stats.monthlySales.thisMonthValue).toLocaleString(
                      "en-GB",
                      { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                    )}
                  </div>
              ...
              <div className="pt-2 md:pt-3 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-green-600 break-all">
                    £
                    {Number(stats.monthlySales.grossProfit).toLocaleString(
                      "en-GB",
                      { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                    )}
                  </span>
              ...
              <div className="space-y-2 md:space-y-3 pt-2 md:pt-3 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-gray-900 break-all">
                    £
                    {Number(
                      stats.boughtSummary?.monthlyBoughtValue || 0,
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-purple-600 break-all">
                    £
                    {Number(
                      stats.boughtSummary?.monthlyPxValue || 0,
                    ).toLocaleString("en-GB", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
              ...
              <div className="pt-2 md:pt-3 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-orange-600 break-all">
                    £
                    {Number(
                      stats.carsIncoming?.awdTotalValue || 0,
                    ).toLocaleString("en-GB", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-lg md:text-2xl font-bold text-emerald-600 break-all">
                  £
                  {Number(
                    stats.financeSales?.monthlyFinanceValue || 0,
                  ).toLocaleString("en-GB", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
              ...
              <div className="pt-2 md:pt-3 border-t border-gray-100 space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm md:text-lg font-bold text-indigo-600 break-all">
                    £
                    {Number(
                      stats.dfFunded?.totalOutstanding || 0,
                    ).toLocaleString("en-GB", {
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-sm md:text-lg font-bold break-all ${
                      (stats.dfFunded?.remainingFacility || 0) < 0
                        ? "text-red-600"
                        : "text-green-600"
                    }`}
                  >
                    £
                    {Number(
                      stats.dfFunded?.remainingFacility || 0,
                    ).toLocaleString("en-GB", {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    })}
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">
                {customerStats?.conversion_rate || 0}%
              </div>
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">
                {customerStats?.top_priority_leads || 0}
              </div>
              <div className="text-gray-500 text-sm mt-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            ...
            <CardContent className="pt-0">
              <div className="space-y-3">
                ...
                {(!customerStats?.top_leads ||
                  customerStats.top_leads.length === 0) && (
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            ...
            <CardContent className="pt-0">
              <div className="space-y-3">
                {(customerStats?.recent_activities || []).map(
                  (activity, index) => (
                    <div
                      key={activity.id}
                      className="flex items-start justify-between p-3 bg-gray-50 rounded-lg border border-gray-100"
                ...
                {(!customerStats?.recent_activities ||
                  customerStats.recent_activities.length === 0) && (
                  <div className="text-center py-8 text-gray-500">
