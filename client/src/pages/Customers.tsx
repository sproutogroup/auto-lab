...
export default function Customers() {
  ...
  const calculatePurchaseValue = (customer: Customer) => {
    ...
    const totalPurchaseValue = customerPurchasesList.reduce(
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px]">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-center p-2 font-semibold text-gray-900 text-xs">
                  Name
                </th>
                <th className="text-center p-2 font-semibold text-gray-900 text-xs">
                  Email
                ...
                customers
                  ...
                  .map((customer: Customer) => (
                    ...
                    >
                      ...
                      <td className="p-2 text-gray-700 text-center text-xs">
                        £
                        {calculatePurchaseValue(customer).toLocaleString(
                          "en-GB",
                          {
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Are you sure you want to delete{" "}
                            {customer.first_name} {customer.last_name}? This
