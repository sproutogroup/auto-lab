     ...
     <Card className="relative overflow-hidden bg-gradient-to-br from-white to-orange-50 border-0 shadow-lg">
      ...
      <CardHeader className="bg-gradient-to-r from-white to-orange-50 border-b border-orange-100">
       <div className="flex items-center gap-4">
        ...
        <div>
         <CardTitle className="text-2xl font-bold text-gray-900">Today's Highlights</CardTitle>
         <p className="text-gray-600 mt-1">{todayAppointments.length} appointments scheduled for today</p>
        </div>
       </div>
      </CardHeader>
      <CardContent className="p-6">
           ...
           <div className="flex items-center justify-between">
            <div className="flex items-center gap-4 flex-1">
             <div className="flex flex-col items-center justify-center p-3 bg-white rounded-xl border border-orange-200 min-w-[80px] shadow-sm">
              <div className="text-sm font-bold text-gray-900">{appointment.appointment_time}</div>
              <div className="text-xs text-gray-500">{appointment.duration_minutes || 30}min</div>
             </div>
      ...
      <div className="flex items-center justify-between">
       <div className="flex items-center gap-4">
        ...
        <div>
         ...
         <p className="text-gray-600 mt-1">{appointments.length} appointments total</p>
        </div>
       </div>
           ...
           <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 flex-1">
             ...
             <div className="flex-1 min-w-0">
              ...
              {appointment.notes && <p className="text-gray-600 text-xs">{appointment.notes}</p>}
             </div>
            </div>
