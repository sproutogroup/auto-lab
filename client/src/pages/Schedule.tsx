...
export default function Schedule() {
 ...
 const filteredJobs = Array.isArray(jobs)
  ? jobs.filter((job: Job) => {
     ...
     const isActiveJob =
      job.job_status !== "completed" && job.job_status !== "failed" && job.job_status !== "cancelled";
           ...
           <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
             <div className="flex items-center space-x-3">
              ...
              <div>
               <div className="font-semibold text-gray-900">{getVehicleRegistration(job)}</div>
              </div>
             </div>
             <DropdownMenu>
            ...
            <div className="flex space-x-2 pt-2">
             ...
             <Button size="sm" variant="outline" onClick={() => handleViewJob(job)} className="h-8 flex-1">
           ...
           {filteredJobs.map((job: Job, index) => (
            ...
            >
             ...
             <td className="py-3 px-2 text-center border-r border-gray-200">
              <div className="text-xs font-semibold text-gray-900">{getVehicleRegistration(job)}</div>
             </td>
             ...
             {/* Assigned To */}
             <td className="py-3 px-2 text-center border-r border-gray-200">
              <div className="text-xs font-medium text-gray-900">{getStaffName(job.assigned_to_id)}</div>
             </td>

             {/* Customer */}
             <td className="py-3 px-2 text-center border-r border-gray-200">
              <div className="text-xs font-medium text-gray-900">{getCustomerName(job.customer_id)}</div>
             </td>

             {/* Scheduled */}
             <td className="py-3 px-2 text-center border-r border-gray-200">
              {job.scheduled_date && (
               <div className="text-xs font-medium text-gray-900">{formatDate(job.scheduled_date)}</div>
              )}
             </td>
              ...
              <div className="flex items-center justify-center space-x-2">
               ...
               <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                 {/* View and Edit */}
                 <DropdownMenuItem onClick={() => handleViewJob(job)} className="cursor-pointer">
