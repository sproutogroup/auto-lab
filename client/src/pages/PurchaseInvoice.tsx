...
export default function PurchaseInvoice() {
  ...
  const [viewingInvoice, setViewingInvoice] = useState<PurchaseInvoice | null>(
    null,
  );
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="mb-6">
          ...
          <Dialog open={isUploadModalOpen} onOpenChange={setIsUploadModalOpen}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload a purchase invoice document with vehicle and seller
                  information
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <Label htmlFor="buyer_name" className="text-sm font-medium">
                      ...
                      <span className="text-xs text-gray-500 ml-1">
                        (Recommended - will be shown in document list)
                      </span>
                    </Label>
                    <Input
                      id="buyer_name"
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setFormData((prev) => ({ ...prev, seller_type: value }))
                      }
                    >
                  ...
                  <div>
                    <Label htmlFor="estimated_collection_date">
        ...
        <p className="text-gray-600">
          Upload and manage purchase invoice documents with comprehensive
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {stats.totalBySellerType.private || 0}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {stats.totalBySellerType.dealer || 0}
              </div>
            </CardContent>
          </Card>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                Start by uploading your first purchase invoice document.
              </p>
              <Button
                  ...
                  {invoices.map((invoice: PurchaseInvoice, index) => (
                    ...
                    >
                      ...
                      <td className="p-3 text-center">
                        {invoice.seller_type ? (
                          <Badge
                            className={getSellerTypeBadge(invoice.seller_type)}
                          >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              const filename = invoice.document_path
                                ...
                                .pop();
                              window.open(
                                `/api/uploads/purchase-invoices/${filename}`,
                                "_blank",
                              );
                            }}
                            className="h-8 w-8 p-0"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {viewingInvoice.seller_type && (
                  <div>
                    ...
                    <Badge
                      className={getSellerTypeBadge(viewingInvoice.seller_type)}
                    >
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-900">
                      {viewingInvoice.document_filename}
                    </span>
                    <span className="text-xs text-gray-500">
                      ({formatFileSize(viewingInvoice.document_size || 0)})
                    </span>
                  </div>
                </div>
              </div>
