             ...
             render={({ field }) => (
              <FormItem className="flex items-center justify-between rounded-xl border border-slate-200 p-4 bg-slate-50">
               <div className="space-y-0.5">
                ...
                <div className="text-sm text-slate-600">Allow this user to access the system</div>
               </div>
               <FormControl>
                <Switch
                 checked={field.value}
        ...
        render={({ field }) => (
         <FormItem className="flex items-center justify-between rounded-lg border p-3">
          <div className="space-y-0.5">
           ...
           <div className="text-sm text-gray-600">Allow this user to access the system</div>
          </div>
          <FormControl>
